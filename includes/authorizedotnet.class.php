...
// 3 - Error
  ...
  if (function_exists(curl_init)) {
	  ...
	  $content = rtrim( $this->field_string, "& " );
	  ...
	  if (curl_errno($ch)) {
	   ...
	   curl_close ($ch);
		...
		echo "<br><br><strong style=color:red;>curl_init() not defined in your PHP system. Please check php.ini and install/update accordingly.</strong>";
	}
